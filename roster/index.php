...
<head lang="en">
    ...
    <!-- My Custom Styles -->
    <link rel="stylesheet" href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/league-of-assassins/css/navbar.css">
...
<div class="container-custom" id="navContainer">
    <script src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/league-of-assassins/js/initialize.js"></script>
    ...
    <div class="well main-well">
        ...
        <table class="table fixed bordered">
            ...
            <!--  <tr class="hunter">
                ...
                <td>Hunter</td>
                <td>Beast Mastery</td>
                <td><a href="http://eu.battle.net/wow/en/character/kul-tiras/Branhold/simple"><img
                        src="../images/icons/wowarmoryicon.png"
                        ></a></td>
            ...
            <tr class="priest">
                ...
                <td>Priest</td>
                <td>Shadow</td>
                <td><a href="http://eu.battle.net/wow/en/character/kultiras/Ginfleth/simple"><img
                        src="../images/icons/wowarmoryicon.png"
                        ></a></td>
